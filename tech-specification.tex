...
\JournalInfo{[Hydra Version]} % Journal information
\Archive{\fdate\;-\;\version\\\text{}\\\textit{This document has not included CIP-43 yet}} % Additional notes (e.g. copyright, DOI, review/research article)
